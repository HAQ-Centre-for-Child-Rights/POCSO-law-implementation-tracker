...
--- This section filters all acts identified with issues. We generate some more information on these acts such as details on orders and judgements to check if we can still include these acts in the analysis. 
