...
Offence wise analysis [Pending - Check dataset with HAQ]

```{r}
offence_file <-
  readr::read_csv(
    here("research", "datasets", "cases_with_primary_offences.csv"),
    col_types = cols(
      `Other headings Type of Offence` = col_character(),
...
'APSA + CP',
'APSA + Storage of CP',
'APSA + CP + Storage of CP',
'SA + CP',
'ASA + CP',
'SH + CP',
'SH + CP + Storage of CP')

category_2 <- c("Abetment of PSA", "Abetment of APSA", "Abetment of SA", "Abetment of ASA", "Abetment of SH", "Abetment of CP", "Attempt to PSA", "Attempt to APSA", "Attempt to SA", "Attempt to ASA", "Attempt to SH", "Abetment of PSA + CP", "Abetment of APSA + CP", "Abetment to SH + CP", "Abetment of SA + Storage of CP", "Abetment of PSA + CP + Storage of CP", "Abetment of PSA + Attempt to PSA", "Abetment of APSA + Attempt to APSA", "Abetment of SA + Attempt to SA")

category_3 <- c("Disclosure of Identity", "Failure to report", "False reporting")

offence_file$category <- ifelse(offence_file$`Type of Offence` %in% category_1, 'c1',ifelse(offence_file$`Type of Offence` %in% category_2,'c2',ifelse(offence_file$`Type of Offence` %in% category_3, 'c3','not_found')))
```
